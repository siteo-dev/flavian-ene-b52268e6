...
const SUBMISSION_ID = 'b52268e6-bd4f-462b-b161-9d8078dc78db'
            ...
            <CardContent className="relative z-10 p-5 sm:p-10">
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-5 mb-5 sm:mb-8">
                <Card className="rounded-2xl border-white/10 bg-white/[0.02]">
                  <CardContent className="p-4 sm:p-6 flex flex-col h-full">
                    ...
                    <div className="flex items-baseline gap-1 mb-1">
                      <span className="text-3xl sm:text-4xl font-black text-white">499 AED</span>
                      <span className="text-zinc-500">/month</span>
                    </div>
                    <div className="inline-flex items-center py-1 mb-4">
                      <span className="text-xs tracking-wider font-medium px-1.5 py-0.5 rounded-full" style={{backgroundColor: `rgba(${ACCENT_RGB}, 0.15)`, color: ACCENT }}>+499 AED <span className='opacity-50'> setup (one-time)</span></span>
                    </div>
                ...
                <Card className="rounded-2xl relative overflow-hidden" style={{ borderColor: `rgba(${ACCENT_RGB}, 0.3)`, backgroundColor: `rgba(${ACCENT_RGB}, 0.05)` }}>
                  ...
                  <CardContent className="p-4 sm:p-6 flex flex-col h-full">
                    ...
                    <div className="flex items-baseline gap-1 mb-1">
                      <span className="text-3xl sm:text-4xl font-black text-white">599 AED</span>
                      <span className="text-zinc-500">/month</span>
                    </div>
              ...
              <Card className="rounded-2xl border-white/[0.06] bg-white/[0.02] overflow-hidden">
                <CardContent className="p-0">
                  ...
                  {[
                    { label: 'Setup cost', others: '800€+', us: '499 AED' },
                    { label: 'Monthly maintenance', others: '150€+', us: 'from 499 AED' },
